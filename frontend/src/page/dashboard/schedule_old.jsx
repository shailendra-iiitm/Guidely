...
import { Card, Button, Checkbox, message, Spin, Select, TimePicker, Popconfirm, Tabs } from "antd";
...
const Schedule = () => {
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      <div className="mb-6">
        <h2 className="text-2xl font-bold mb-2">Weekly Schedule Management</h2>
        <p className="text-gray-600">
          Set your weekly availability by adding time slots for each day. 
          This will be used to generate your booking calendar.
        </p>
      </div>
      ...
      <Tabs defaultActiveKey="1" className="mb-6">
        ...
        <TabPane tab="Calendar" key="2">
          <AvailabilityCalendar 
            ...
            onUpdateUnavailableDates={setUnavailableDates}
          />
        </TabPane>
      </Tabs>
